...
console.log(result); // {id:1, name:"北海道", kana:"ホッカイドウ", en:"Hokkaidō", neighbor:[2]}
...
console.log(result); // {id:13, region:3, name:"東京都", short:"東京", kana:"トウキョウ", en:"Tōkyō", neighbor:[11, 12, 14, 19]}
...
console.log(result); // {id:8, name:"九州",   kana:"キュウシュウ", en:"Kyūshū",   neighbor:[6, 7]}

result = jpPrefecture.findBy("region", "id", 8, "name");
console.log(result); // "九州"

result = jpPrefecture.findBy("region", "en", "Chūgoku", ["id", "name"]);
...
console.log(result); // {id: 3, name: "関東", kana: "カントウ", en: "Kantō", neighbor: Array[2]}
...
console.log(results); // [{id:1, name:"北海道", kana:"ホッカイドウ", en:"Hokkaidō", neighbor:[2]}]
...
Determine if the specified two regions or prefectures are adjacent.
...
result = jpPrefecture.isNeighbor("pref", "神奈川県", "Hokkaidō");
console.log(result); // false
```
...
result = jpPrefecture.isPrefNeighbor("神奈川県", "Hokkaidō");
console.log(result); // false
```
...
result = jpPrefecture.neighborSize("region", "Tōhoku");
console.log(result); // 1

result = jpPrefecture.neighborSize("region", "hoge");
console.log(result); // 0

result = jpPrefecture.neighborSize("pref", "Tōkyō");
...
result = jpPrefecture.regionNeighborSize("Tōhoku");
console.log(result); // 2
```
...
[
  0: {
    region: {id:1, name:"北海道", kana:"ホッカイドウ", en:"Hokkaidō", neighbor:[2]},
    prefectures: [
      {id:1,  region:1, name:"北海道",   short:"北海道", kana:"ホッカイドウ", en:"Hokkaidō",  neighbor:[2]},
    ]
  },
  1: {
    region: {id:2, name:"東北",   kana:"トウホク",     en:"Tōhoku",   neighbor:[1]},
    prefectures: [
...
[
  ...
  {id:6, name:"中国",   kana:"チュウゴク",   en:"Chūgoku",  neighbor:[5, 7, 8]},
  {id:7, name:"四国",   kana:"シコク",       en:"Shikoku",  neighbor:[5, 6, 8]},
  {id:8, name:"九州",   kana:"キュウシュウ", en:"Kyūshū",   neighbor:[6, 7]}
]
```
...
[
  ...
  {id:13, region:3, name:"東京都",   short:"東京",   kana:"トウキョウ",   en:"Tōkyō",     neighbor:[11, 12, 14, 19]},
  ...
  {id:26, region:5, name:"京都府",   short:"京都",   kana:"キョウト",     en:"Kyōto",     neighbor:[18, 24, 25, 27, 28, 29]},
  {id:27, region:5, name:"大阪府",   short:"大阪",   kana:"オオサカ",     en:"Ōsaka",     neighbor:[26, 28, 29, 30]},
  {id:28, region:5, name:"兵庫県",   short:"兵庫",   kana:"ヒョウゴ",     en:"Hyōgo",     neighbor:[26, 27, 30, 31, 33, 36, 37]},
  ...
  {id:39, region:7, name:"高知県",   short:"高知",   kana:"コウチ",       en:"Kōchi",     neighbor:[36, 38]},
  ...
  {id:44, region:8, name:"大分県",   short:"大分",   kana:"オオイタ",     en:"Ōita",      neighbor:[35, 38, 40, 43, 45]},
